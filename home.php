...
<section class="py-0">
    <div class="container">
    <div class="row">
        <div class="col-lg-2 px-1 mt-4 border-right text-sm position-sticky ">
                        ...
                        <a class="card product-item text-reset text-decoration-none" href=".?p=view_product&id=<?php echo md5($row['id']) ?>">
                            ...
                            <div class="card-body p-4">
                                <div class="">
                                    ...
                                    <!-- Product price-->
                                         <b class="text-orange">₱ <?php echo $price ?></b>
                                </div>
                                <p class="m-0"><small><span class="text-muted">Category:</span> <?php echo $row['bname'] ?></small></p>
