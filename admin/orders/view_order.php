            ...
            <table class="table-striped table table-bordered" id="list">
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <th class="text-right"><?php echo number_format($amount+65)  ?></th>
                    </tr>
                </tfoot>
            </table>
        </div>
            ...
            <div class="col-6 row row-cols-2">
                ...
                <?php 
                    switch($status){
	                    ...
	                    break;
                        case '1':
                            echo '<span class="badge badge-primary px-3 rounded-pill">Packed</span>';
	                    break;
                        case '2':
...
<div class="modal-footer">
    <button type="button" class="btn btn-danger btn-flat btn-sm" id="refund">Refund Order</button>
