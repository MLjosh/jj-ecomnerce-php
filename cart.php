                    ...
                    <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                        <div class="d-flex align-items-center col-8">
                            ...
                            <div>
                                ...
                                <small class="text-muted"><?php echo ($row['brand']) ?></small><br>
<!--                                 <small class="text-muted"><?php echo ($row['category']) ?></small><br> -->
                                <small class="text-muted"><?php echo ($row['variant']) ?></small><br>
                                <p class="mb-1 mb-sm-1"><small><b>Price: ₱&nbsp; <span class="price"><?php echo format_num($row['price']) ?></span></small></b></p>
                                <div>
                        ...
                        <div class="col text-right align-items-center d-flex justify-content-end"><h4>₱&nbsp;</h4>
                            <h4><b class="total-amount"><?php echo format_num($row['price'] * $row['quantity']) ?></b></h4>
                        </div>
                    </div>
                <?php endwhile; ?>
                <div class="d-flex w-100 justify-content-between mb-2 py-2 border-bottom">
                    <div class="col-8 d-flex justify-content-end"><h5>Shipping Fee:</h5></div>
                    <div class="col d-flex justify-content-end"><h5>₱&nbsp;</h5><h5>65</h5></div>
                </div>
                <div class="d-flex w-100 justify-content-between mb-2 py-2 border-bottom">
                    <div class="col-8 d-flex justify-content-end"><h4>Grand Total:</h4></div>
                    <div class="col d-flex justify-content-end"><h4>₱&nbsp;</h4><h4 id="grand-total">-</h4></div>
                </div>
            </div>
        </div>
        <div class="d-flex w-100 justify-content-end">
            <a href="./?p=checkout" class="btn btn-sm btn-flat btn-dark p-3 mb-5" >Checkout</a>
        </div>
    </div>
</section>
<script>
