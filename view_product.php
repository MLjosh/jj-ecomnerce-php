...
<section class="py-5">
    <div class="container px-4 px-lg-5 my-5">
        ...
        <div class="row gx-4 gx-lg-5 align-items-center">
            <div class="col-md-6">
                <img class="card-img-top mb-5 mb-md-0 border border-light" loading="lazy" id="display-img" src="<?php echo validate_image($img) ?>" alt="..." />
                <div class="mt-2 row gx-2 gx-lg-2 row-cols-4 row-cols-md-3 row-cols-xl-4 justify-content-start">
                    <?php 
            ...
            <div class="col-md-6">
                ...
                <h3 class=" fw-bolder border-bottom border-primary pb-1"><?php echo $name ?></h3>
            ...
            <div class="col mb-5">
                <a class="card product-item text-reset text-decoration-none" href=".?p=view_product&id=<?php echo md5($row['id']) ?>">
                    ...
                    <div class="card-body p-4">
                        <div class="">
                            <!-- Product name-->
                            <h6 class="fw-bolder"><?php echo $row['name'] ?></h6>
                            <!-- Product price-->
                            <span><b class="text-orange">₱ <?php echo $price ?></b></span>
                            <p class="m-0"><small>Category: <?php echo $row['bname'] ?></small></p>
